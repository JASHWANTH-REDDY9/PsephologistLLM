...
const Home = () => {
    ...
    <div class="carousel-indicators"><button class="active" type="button" data-bs-target="#carousel-1" data-bs-slide-to="0"></button><button type="button" data-bs-target="#carousel-1" data-bs-slide-to="1"></button><button type="button" data-bs-target="#carousel-1" data-bs-slide-to="2"></button></div>
            ...
            {/* <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap' }}>
                <img src="http://127.0.0.1:5000/plot/sa-bar.png" alt="Sentiment Bar Chart" style={{ width: '10%' }} />
                <img src="http://127.0.0.1:5000/plot/sa-pie.png" alt="Sentiment Pie Chart" style={{ width: '10%' }} />
                <img src="http://127.0.0.1:5000/plot/sa-bar1.png" alt="Sentiment Bar Chart" style={{ width: '10%' }} />
                <img src="http://127.0.0.1:5000/plot/sa-pie1.png" alt="Sentiment Pie Chart" style={{ width: '10%' }} />
            </div> */}
            <Persons />
            <Footer />
        </div>
